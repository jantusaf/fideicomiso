...
export default function SelectTextFields(props) {
  ...
  const borrar = async () => {
    console.log(pago);
    try {
      await servicioAdmin.borrarcomprobante(props.id);
      props.getData();
    } catch (error) {
      console.error(error);
    ...
    <Box sx={{ display: "inline-flex", alignItems: "center" }}>
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 1.25 }}>
            ...
            <Box sx={{ lineHeight: 1.1 }}>
              ...
              <Typography sx={{ mt: 0.3, fontWeight: 650, opacity: 0.9, fontSize: 12.5 }}>
                Esta acción elimina el comprobante asociado.
              </Typography>
            </Box>
          </Box>
        ...
        >
          ...
          <Typography sx={{ mt: 0.75, fontWeight: 650, color: alpha("#0b2b3a", 0.75) }}>
            Después de borrarlo, no vas a poder verlo ni descargarlo nuevamente.
          </Typography>
        </DialogContent>
