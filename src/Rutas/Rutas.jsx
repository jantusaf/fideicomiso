...
const Rutas = [
	...
	// ───────── Mapa general · Niveles 2 y 5 ─────────
	{
		element: <RutaProtegida niveles={[2, 5]} />,
		children: [
	...
	// ───────── Nivel 2 · Empleados ─────────
	{
		element: <RutaProtegida niveles={[2]} />,
		children: [
	...
	// ───────── Nivel 3 · Gerencia ─────────
	{
		element: <RutaProtegida niveles={[3]} />,
		children: [
	...
	// ───────── Nivel 6 · Flujo de fondos ─────────
	{
		element: <RutaProtegida niveles={[6]} />,
		children: [
	...
	// ───────── Nivel 7 · Control de IC4 ─────────
	{
		element: <RutaProtegida niveles={[7]} />,
		children: [
	...
	// ───────── Nivel 5 · Visor de mapas ─────────
	{
		element: <RutaProtegida niveles={[5]} />,
		children: [
			{ path: '/usuariomapas/inicio', element: <Mapasusuario /> },
		],
	},

	// ───────── Administración (nivel 10, sin uso hoy) ─────────
	{
		element: <RutaProtegida niveles={[10]} />,
		children: [
	...
	// ───────── Catch-all: sin sesión → /login ; con sesión → NotFound ─────────
	{
		path: '*',
		element: (
			<RutaProtegida>
